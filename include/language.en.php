<?
    ...
    $guil['de'] = array(
        ...
        'damagehealthreatpertarget' => 'Damage/Heal/Threat per Target',
        'ability'                   => 'Ability',
        'target'                    => 'Target',
        'damage'                    => 'Damage',
        'heal'                      => 'Heal',
        ...
        'noxpsnote'                 => 'XPS-values are not shown in the summary, because they make no sense over the full duration of a logfile.',
        'sum'                       => 'Sum',
        'overall'                   => 'Overall',
